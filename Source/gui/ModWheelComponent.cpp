...
ModWheelComopnent::ModWheelComopnent (juce::AudioProcessorValueTreeState& apvts)
    : osc1_lfo1_ ("Osc 1 LFO 1"), osc1_waveform_ ("Osc 1 Shape"), osc2_lfo1_ ("Osc 2 LFO 1"), osc2_waveform_ ("Osc 2 Shape"), filter_lfo1_ ("Filter LFO 1"), filter_cutoff_ ("Filter Freq")
{
