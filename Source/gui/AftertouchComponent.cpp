...
AftertouchComponent::AftertouchComponent (juce::AudioProcessorValueTreeState& apvts)
    : osc1_lfo2_ ("Osc 1 LFO 2"), osc1_waveform_ ("Osc 1 Shape"), osc2_lfo2_ ("Osc 2 LFO 2"), osc2_waveform_ ("Osc 2 Shape"), filter_lfo2_ ("Filter LFO 2"), filter_cutoff_ ("Filter Freq")
{
